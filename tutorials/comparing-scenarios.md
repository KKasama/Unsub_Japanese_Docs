...
> **⚠️ 注意：**
> シナリオの作成がお済みでない場合は、[こちらのページ](/tutorials/create-a-package.md)を参考に作成をお願いいたします。。
...
ここでは、2つのシナリオを比較します。まだ、シナリオを作成していない場合は、[シナリオ作成チュートリアル](/tutorials/create-a-scenario.md)に沿って、今すぐシナリオを作成してください。

シナリオを作成したら、[同じシナリオのコピーを作成](/how-to-guides/copy-scenario.md)します。
