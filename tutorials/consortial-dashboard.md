...
機関Unsubダッシュボードとの大きな違いは、Member Institutionsの新しいタブがあることです。 Member Institutionsタブをクリックすると、あなたのコンソーシアムパッケージに含まれる教育機関のリストが表示されます。
...
Please get in touch if you have any questions about the consortial dashboard (<support@unsub.org>).&#x20;

コンソーシアムダッシュボードの使い方は、インスティテューショナルダッシュボードの使い方と同じです。パラメータを変更したり、タイトルをアラカルトで購読することで、予測がどのように変化するかを確認することができます。 コンソーシアム・ダッシュボードの値は、Member Institutionsタブに含まれるメンバー機関から蓄積されたもので、含まれる機関を変更するたびに予測も変更されます。 通常の機関別ダッシュボードと同様に、ダッシュボード内のすべてのタイトルのテーブルビューを見ることができ、データをエクスポートすることができます。 コンソーシアムダッシュボード（<support@unsub.org>）についてのご質問は、こちらまでご連絡ください。
