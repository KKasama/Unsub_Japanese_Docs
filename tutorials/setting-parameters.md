> For the complete documentation index, see [llms.txt](https://tamaki.gitbook.io/unsub_guide_jpn/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://tamaki.gitbook.io/unsub_guide_jpn/chtoriaru/paramt.md).
...
<figure><img src="/files/NknR93n9DSYDjGryTnKY" alt=""><figcaption></figcaption></figure>

各パラメーターの説明（詳細）は、表示のオン・オフを切り替えられるようになっています。

<figure><img src="/files/12f8fvVFhUtvQyN6nXUJ" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/txObn56NRfwYaMLGeVHX" alt=""><figcaption><p>Include Bronze OAがtrue(含まれる)状態の設定</p></figcaption></figure>

パラメータ名、説明、または値（下図の場合true）の領域のどこかをクリックすると、次のようなポップアップが表示されます。

<figure><img src="/files/ECK8wSPK6zpv3erc2iJd" alt=""><figcaption><p>"True"に設定されたBronze OA(Open Access)のポップアップ</p></figcaption></figure>

ポップアップの青いスイッチと「Include Bronze OA」という文字がある部分をクリックするとスイッチが左に移動し、以下のような白色に変わります。

<figure><img src="/files/uf6wnPJDTfBkteilSABH" alt=""><figcaption></figcaption></figure>
