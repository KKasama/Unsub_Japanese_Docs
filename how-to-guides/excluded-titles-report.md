...
COUNTERレポートファイルにアップロードしたすべてのタイトルがUnsubのダッシュボード上に反映されないことがあります。[こちらのページ](/troubleshooting/missing-title.md)で、タイトルが除外される4つの主な理由を詳しく説明しています。

パッケージの「セットアップ」タブの「診断データ」セクションに、スプレッドシートをダウンロードできる「除外タイトル」のページがあります。
